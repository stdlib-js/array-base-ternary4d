...
```javascript
ternary4d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-ternary4d@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-ternary4d@v0.2.0-umd/browser.js"></script>
```
